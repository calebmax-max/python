...
print("The diffeerence of the numbers is: ", difference)
...
#modulus - This means the reminder of the number when it gets subdivided by another one
number9 = 14
number10 = 5
modulus = number9 % number10
print("The modulus of the numbers is: ", modulus)

# Floor division - This is the number of times  a number subdivides another ignoring the reminder
